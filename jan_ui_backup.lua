...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(153, 0, 17),
    accentcolor2 = Color3.fromRGB(140, 29, 42),
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddKeybind(default, newkeycallback, flag)
                    ...
                    local text = keybind.default == "None" and "[None]" or "[" .. keybind.value .. "]"-- or "[" .. (shorter_keycodes[keybind.default.Name] or keybind.default.Name) .. "]"
