...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(18, 21, 97),
    accentcolor2 = Color3.fromRGB(18, 21, 97),
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddKeybind(default, newkeycallback, flag)
                    ...
                    local text = keybind.default == "None" and "[None]" or "[" .. string.upper(keybind.value) .. "]"-- or "[" .. (shorter_keycodes[keybind.default.Name] or keybind.default.Name) .. "]"
				    ...
				    pcall(newkeycallback)
                                ...
                                if keybind.value ~= "None" and string.lower(tostring((input.KeyCode)):split(".")[3]) == string.lower(keybind.value) then
